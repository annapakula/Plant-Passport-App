  ...
  return passportsList.map((passport) => {
    return (
      <div key={passport.id}>
          ...
          <thead className="table__head">
            <tr className="table__head-row">
              <th className="table__head-cell" colSpan="4">
                ...
                />
                <h3 className="table__header">Paszport Roślin &#92; Plant Passport</h3>
              </th>
            </tr>
          </thead>
          <tbody>
            <tr>
              ...
              <td className="table__cell table__cell--data">PL-18/62/5804</td>
            </tr>
            <tr>
        ...
        <DeletePassport handleDeletePassport={() => handleDeletePassport(passport.id)}/>
